...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    href: 'https://github.com/', // Replace with your actual GitHub URL if desired
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/', // Replace with your actual LinkedIn URL if desired
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  {
    name: 'Gmail',
    href: 'mailto:shreyanshtiwari.cs@gmail.com',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/', // Replace with your actual Instagram URL if desired
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={styles.form}>
            ...
            <div className={styles.field}>
              ...
              <a
                ...
                style={{ display: 'block', textDecoration: 'none', cursor: 'pointer' }}
              >
                linkedin.com/in/shreyansh-tiwari
              </a>
            </div>
